	...
	if chat_id in dop.get_adminlist():
		if message_text == 'Вернуться в главное меню' or message_text == '/adm':
			...
			if ' приветствие пользователя' in message_text: 
				...
				message = 'userfalse'
			with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + '.txt', 'w', encoding ='utf-8') as f: f.write(message)
			...
			if 'В виде файла' == message_text: 
				with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + 'good_format.txt', 'w',  encoding='utf-8') as f: f.write('file')
				...
				with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + 'good_format.txt', 'w',  encoding='utf-8') as f: f.write('text')
...
Гайды по настройке обоих платёжек есть, их можно получить при добавление соотвествующей платёжки""", reply_markup=user_markup, parse_mode='Markdown')
			...
			key = telebot.types.InlineKeyboardMarkup()
			key.add(telebot.types.InlineKeyboardButton(text='Вернуться в главное меню админки', callback_data='Вернуться в главное меню админки'))
			bot.send_message(chat_id, 'Введите *API key* от биржи *coinbase*', reply_markup=key, parse_mode='Markdown')
			...
			if 'По всем юзерам' == message_text: 
				with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + '.txt', 'w', encoding='utf-8') as f:  f.write('all\n')
				amount = dop.user_loger() #получение числа юзер
			elif 'Только купившим' == message_text: 
				with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + '.txt', 'w', encoding='utf-8') as f:  f.write('buyers\n')
			...
			if sost_num == 1:
				with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + '.txt', encoding='utf-8') as f:  what_message = f.read()#достаётся сообщение, ответ на которое нужно изменить
				...
				with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + 'good_name.txt', 'w',  encoding='utf-8') as f: f.write(message_text)
				key = telebot.types.InlineKeyboardMarkup()
				key.add(telebot.types.InlineKeyboardButton(text='Отменить и вернуться в главное меню админки', callback_data='Вернуться в главное меню админки'))
				...
				with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + 'good_description.txt', 'w',  encoding='utf-8') as f: f.write(message_text)
				user_markup = telebot.types.ReplyKeyboardMarkup(True, True)
				...
				try:
					...
					if message  >= 0:
						with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + 'good_minimum.txt', 'w',  encoding='utf-8') as f: f.write(str(message_text))
						key = telebot.types.InlineKeyboardMarkup()
						key.add(telebot.types.InlineKeyboardButton(text='Отменить и вернуться в главное меню админки', callback_data='Вернуться в главное меню админки'))
				...
				try:
					...
					with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + 'good_price.txt', 'w',  encoding='utf-8') as f: f.write(str(message_text))
					key = telebot.types.InlineKeyboardMarkup()
					key.add(telebot.types.InlineKeyboardButton(text='Добавить товар в магазин', callback_data='Добавить товар в магазин'))
					key.add(telebot.types.InlineKeyboardButton(text='Отменить и вернуться в главное меню админки', callback_data='Вернуться в главное меню админки'))
					
					with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + 'good_name.txt',  encoding='utf-8') as f: name = f.read()
					with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + 'good_description.txt',  encoding='utf-8') as f: description = f.read()
					with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + 'good_format.txt',  encoding='utf-8') as f: format = f.read()
					with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + 'good_minimum.txt',  encoding='utf-8') as f: minimum = f.read()
					with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + 'good_price.txt',  encoding='utf-8') as f: price = f.read()
				...
				if a == 0: bot.send_message(chat_id, 'Позиции с таким названием нет!\nВыберите заново!')
					...
					key = telebot.types.InlineKeyboardMarkup()
					key.add(telebot.types.InlineKeyboardButton(text='Отменить и вернуться в главное меню админки', callback_data='Вернуться в главное меню админки'))
					with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + '.txt', 'w', encoding='utf-8') as f: f.write(message_text)
				...
				with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + '.txt', encoding='utf-8') as f: name = f.read()
				con = sqlite3.connect(files.main_db)
				cursor = con.cursor()
				...
				with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + '.txt', encoding='utf-8') as f: good_name = f.read()
				...
				try:
					...
					if len(cursor.fetchall()) > 0: bot.send_message(chat_id,'Такой номер уже есть в базе данных!')
						...
						with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + '.txt', 'w', encoding='utf-8') as f: f.write(message_text)
						bot.send_message(chat_id, 'Теперь введите токен', parse_mode='Markdown')
				...
				with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + '.txt', encoding='utf-8') as f: phone = f.read()
				...
				key = telebot.types.InlineKeyboardMarkup()
				key.add(telebot.types.InlineKeyboardButton(text = 'Вернуться в главное меню админки', callback_data = 'Вернуться в главное меню админки'))
				bot.send_message(chat_id, 'Введите *API Secret*', reply_markup=key, parse_mode='Markdown')
				with shelve.open(files.sost_bd) as bd : bd[str(chat_id)] = 18

			elif sost_num == 18:
				with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + '.txt', encoding='utf-8') as f: api_key = f.read()
				if dop.check_coinbase_valid(api_key, message_text) is True:
					...
					key = telebot.types.InlineKeyboardMarkup()
					key.add(telebot.types.InlineKeyboardButton(text = 'Вернуться в главное меню админки', callback_data = 'Вернуться в главное меню админки'))
					bot.send_message(chat_id, 'Данные не валид!\n\nВведите *API key* от биржи *coinbase* или вернитесь в главное меню', reply_markup=key, parse_mode='MarkDown')
					with shelve.open(files.sost_bd) as bd : bd[str(chat_id)] = 17

			elif sost_num == 19:
				try:
					if int(message_text) > 0:
						with open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + '.txt', 'a', encoding='utf-8') as f: f.write(message_text)
						key = telebot.types.InlineKeyboardMarkup()
						key.add(telebot.types.InlineKeyboardButton(text='Отменить и вернуться в главное меню админки', callback_data='Вернуться в главное меню админки'))
						group = dop.normal_read_line('/home/tgshop/shop/data/hTemp/' + str(chat_id) + '.txt', 0)
				...
				group = dop.normal_read_line('/home/tgshop/shop/data/hTemp/' + str(chat_id) + '.txt', 0)
				amount_users = dop.read_my_line('/home/tgshop/shop/data/hTemp/' + str(chat_id) + '.txt', 1)
...
def ad_inline(callback_data, chat_id, message_id):
	if 'Вернуться в главное меню админки' == callback_data:
		...
		con = sqlite3.connect(files.main_db)
		cursor = con.cursor()
		cursor.execute("INSERT INTO goods VALUES(?, ?, ?, ? , ?, ?)", (name, description, format, minimum, price, '/home/tgshop/shop/data/hgoods/' + name + '.txt'))
		con.commit()
		con.close()
		user_markup = telebot.types.ReplyKeyboardMarkup(True, False)
		user_markup.row('Добавить новую позицию на витрину', 'Удалить позицию')
		...
		with open('/home/tgshop/shop/data/hgoods/' + name + '.txt', 'w',  encoding ='utf-8') as f: pass #создаёся файл для товара

	elif callback_data == 'Остановить загрузку':
		good_name = open('/home/tgshop/shop/data/hTemp/' + str(chat_id) + '.txt', encoding ='utf-8').read()
		bot.delete_message(chat_id, message_id) #удаляется старое сообщение
		con = sqlite3.connect(files.main_db)
		cursor = con.cursor()
		cursor.execute("SELECT name, price FROM goods;")
